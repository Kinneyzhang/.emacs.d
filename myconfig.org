...
** print special symbol
   #+BEGIN_SRC emacs-lisp
     ...
     (global-set-key (kbd "C-c s ot") 'print-tick)
     (global-set-key (kbd "C-c s d") 'print-dot)
     (global-set-key (kbd "C-c s h") 'print-hollow-dot)
     (global-set-key (kbd "C-c s s") 'print-star)
   #+END_SRC
** org-shift-left/org-shift-right
   #+BEGIN_SRC emacs-lisp
...
* Key bindings
  #+BEGIN_SRC emacs-lisp
    ...
    (global-set-key "\C-csnc" 'aya-create)
    (global-set-key "\C-csnp" 'aya-persist-snippet)
    (global-set-key "\C-csne" 'aya-expand)
