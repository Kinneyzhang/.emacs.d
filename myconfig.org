...
* Org-mode
  #+BEGIN_SRC emacs-lisp
    ...
    (setq org-todo-keywords
	  '((type "Yearly(1!)" "Monthly(2!)" "|")
	    (sequence "TODO(t!)"  "|" "DONE(d!)" "ABORT(a@/!)")
	    ))

    (setq org-todo-keyword-faces
	  '(("Yearly" . (:background "#20a0ff" :foreground "black" :weight bold))
	    ("Monthly" . (:background "#9a5bbd" :foreground "black" :weight bold))
	    ("TODO" . (:background "DarkOrange" :foreground "black" :weight bold))
	    ("DONE" . (:background "Darkgreen" :foreground "black" :weight bold)) 
	    ("ABORT" . (:background "gray" :foreground "black"))
	    ))

    (setq org-tag-alist '(("monthly" . ?m) ("yearly" . ?y)))
