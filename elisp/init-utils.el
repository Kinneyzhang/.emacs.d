...
(defun gk/deploy-langc ()
  ...
  (let ((display-buffer-alist
         '(("\\*Async Shell Command\\*" display-buffer-no-window))))
    (async-shell-command "cd C:/Users/26289/LangC && git add . && git commit -m 'update' && git push")))
...
(defun gk/pull-all ()
  ...
  (let ((display-buffer-alist
         '(("\\*Async Shell Command\\*" display-buffer-no-window))))
    (async-shell-command "cd C:/Users/26289/gknows && git pull")
    (async-shell-command "cd c:/Users/26289/Hackings/mygtd && git pull")
    (async-shell-command "cd C:/Users/26289/LangC && git pull")))
