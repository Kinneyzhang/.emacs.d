(custom-set-variables
 ...
 '(package-selected-packages
   '(elisp-demos gnugo epkg emms podcaster expand-region move-text sqlite3 esqlite emacsql-sqlite emacs-edbi gnuplot-mode gnuplot elscreen posframe solarized-theme cyberpunk-2019-theme cyberpunk-theme material-theme gruvbox-theme zenburn-theme leuven-theme spaceline-all-the-icons debbugs auto-org-md super-save timerfunctions youdao-dictionary winum which-key webpaste web-server web-mode web-beautify w3m vterm-toggle visual-fill-column tree-mode tramp-term toc-org symbol-overlay sunshine spotlight smartparens smart-comment separedit search-web robe restart-emacs rainbow-delimiters quelpa-use-package pyenv-mode py-autopep8 proxy-mode popwin pomidor pip-requirements php-mode persist pdf-tools password-generator paredit osx-dictionary org-ql org-pomodoro org-noter org-download org-bullets org-analyzer org-agenda-property nov neotree moz-controller markdown-mode major-mode-hydra magit macrostep lispy link-hint libmpdee ledger-mode jupyter jsonrpc js2-refactor js-comint ivy-rich ivy-prescient ivy-posframe ivy-pass indent-guide impatient-mode imenu-list idle-org-agenda hungry-delete hierarchy hide-mode-line helpful helm-core graphql goto-chg google-translate git general furl flycheck-ledger exec-path-from-shell enh-ruby-mode emmet-mode elpy elisp-slime-nav elfeed el2org ego dracula-theme django-mode diredfl diminish dashboard darkroom counsel-world-clock counsel-projectile counsel-osx-app company-web company-tern company-prescient centaur-tabs calibredb calfw-org calfw cal-china-x browse-at-remote bm benchmark-init all-the-icons-ivy all-the-icons-dired alarm-clock ac-html-bootstrap ac-html-angular))
